...
import (
	"fmt"
	"github.com/go-examples/goa/response_file/client"
	"github.com/go-examples/goa/response_file/tool/cli"
...
func main() {
	...
	app := &cobra.Command{
		Use:   "file-cli",
		Short: `CLI client for the file service`,
	}
